...
public class AdditionalEntityAttributes {
    ...
    public static final EntityAttribute GENERIC_PROJECTILE_DAMAGE = register(projectileDamageId, new ClampedEntityAttribute("attribute.name.generic.projectile_damage", 2.0, 0.0, 1024.0));
